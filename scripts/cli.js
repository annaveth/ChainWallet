...
const contractABI = require("../artifacts/contracts/Chainwallet.sol/Chainwallet.json").abi;

program
    .name("chainwallet-cli")
    .description("CLI tool for Chainwallet smart contract")
    .version("1.0.0");
